...
$query="SELECT * FROM books_records WHERE BOOK_NAME='$SEARCH' Or AUTHOR_NAME='$SEARCH' Or SUBJECT='$SEARCH'";

$result=mysqli_query($dbc,$query)
				or die('Error querying database');
	echo"<table align='center' style=''><th>BOOK NAME</th>
	             <th>AUTHOR NAME</th>
	             <th>EDITION</th>
				 <th>NO. OF VOLUME AVAILABLE</th>";
	while($view=mysqli_fetch_array($result)){
	echo "
	<p><tr style='border:0.5px solid black'><td>{$view['BOOK_NAME']}<p></td>
